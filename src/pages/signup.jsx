    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto '>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img className='w-full rounded-2xl' src='https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=773&q=80' 
          alt='key' />
        </div>
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input type="text" id='name' value={name} onChange={onChange} placeholder="Full Name" className='mb-6 w-full px-4 py-2 text-xl
            ...
            <p>
              <Link to="/ForgetPassword" className='text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out'>Forget Password?</Link>
            </p>
